...
[![Go Report Card](https://goreportcard.com/badge/github.com/webx-top/qmgo)](https://goreportcard.com/report/github.com/webx-top/qmgo)
[![GitHub release](https://img.shields.io/github/v/tag/qiniu/qmgo.svg?label=release)](https://github.com/webx-top/qmgo/releases)
[![GoDoc](https://pkg.go.dev/badge/github.com/webx-top/qmgo?status.svg)](https://pkg.go.dev/github.com/webx-top/qmgo?tab=doc) 
...
- Use `go mod` to automatically install dependencies by `import github.com/webx-top/qmgo`

Or 

- Use `go get github.com/webx-top/qmgo`
...
- Transactions
    ...
    ````
    [More about transaction](https://github.com/webx-top/qmgo/wiki/Transactions)
...
- Hooks
    ...
    ````
    [More about hooks](https://github.com/webx-top/qmgo/wiki/Hooks)
...
- Automatically fields
    ...
    Check [examples here](https://github.com/webx-top/qmgo/blob/master/field_test.go)

    [More about automatically fields](https://github.com/webx-top/qmgo/wiki/Automatically-update-fields)
...
## `Qmgo` vs `mgo`
[Differences between qmgo and mgo](https://github.com/webx-top/qmgo/wiki/Differences-between-Qmgo-and-Mgo)
...
- Join [qmgo discussions](https://github.com/webx-top/qmgo/discussions)
