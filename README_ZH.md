...
推荐方式是使用`go mod`，通过在源码中`import github.com/webx-top/qmgo` 来自动安装依赖。

当然，通过下面方式同样可行：

```
go get github.com/webx-top/qmgo
```
...
- 事务
    ...
    [关于事务的更多内容](https://github.com/webx-top/qmgo/wiki/Transactions)
...
- Hooks
    ...
    [Hooks 详情介绍](<https://github.com/webx-top/qmgo/wiki/Hooks--(%E7%AE%80%E4%BD%93%E4%B8%AD%E6%96%87)>)
...
- 自动化更新fields
    ...
    [例子介绍](https://github.com/webx-top/qmgo/blob/master/field_test.go)

    [自动化 fields 详情介绍](https://github.com/webx-top/qmgo/wiki/Automatically-update-fields)
...
[Qmgo 和 Mgo 的差异](https://github.com/webx-top/qmgo/wiki/Differences-between-Qmgo-and-Mgo)
...
- 加入 [qmgo discussions](https://github.com/webx-top/qmgo/discussions)
